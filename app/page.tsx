  ...
  return (
    ...
    >
      ...
      >
        <div className="flex-1">
          <p className="text-zinc-600 dark:text-zinc-400">
            Engineering efficiency, inspiring connection. My goal is to design technologies that remove barriers and strengthen the bonds between people.
          </p>
        </div>
      </motion.section>
      <motion.section
      ...
      <motion.section
        ...
        transition={TRANSITION_SECTION}
      >
<h3 className="mb-5 text-lg font-medium">Extracurricular Leadership</h3>
        <div className="flex flex-col space-y-2">
          {EXTRACURRICULARS.map((job) => (
            <a
              className="relative overflow-hidden rounded-2xl bg-zinc-300/30 p-[1px] dark:bg-zinc-600/30"
              href={job.link}
              target="_blank"
